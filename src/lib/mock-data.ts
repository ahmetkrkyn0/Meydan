...
export const athletes: Athlete[] = [
  {
    ...
    age: 26,
    gender: "E",
    club: "Türkiye Olimpik Kampı",
    rank: { national: 1, world: 3 },
    followers: 12_400,
    supporters: 2_103,
    ...
    alive: true,
    trend: "+12%",
    socials: { instagram: "@metegazoz", twitter: "@metegazoz" },
    achievements: [
      { year: "2021", title: "Tokyo Olimpiyat Altın Madalya" },
      { year: "2023", title: "Avrupa Şampiyonası Gümüş" },
      { year: "2024", title: "Dünya Kupası 1." },
    ],
  ...
  },
  {
    ...
    alive: true,
    trend: "+15%",
    socials: { instagram: "@zeynepsonmez" },
    achievements: [
  ...
  },
  {
    ...
    alive: true,
    trend: "+24%",
    socials: { instagram: "@sureyyademir" },
    achievements: [
  ...
  },
  {
    ...
    age: 51,
    gender: "E",
    club: "Milli Savunma Spor Kulübü",
    rank: { national: 1, world: 12 },
    followers: 21_900,
    supporters: 1_840,
    ...
    alive: true,
    trend: "+8%",
    socials: { instagram: "@yusufdikec" },
    achievements: [
      { year: "2024", title: "Paris Olimpiyat Gümüş" },
      { year: "2018", title: "Avrupa Şampiyonu" },
    ],
    nextEvent: { date: "12 Haz", title: "ISSF Dünya Kupası", city: "Münih" },
    lastResults: [
      { opponent: "—", result: "W", score: "Final" },
      { opponent: "—", result: "W", score: "Yarı" },
    ],
  },
  {
    id: "a5",
    slug: "buse-naz-cakiroglu",
    ...
    age: 28,
    gender: "K",
    club: "Türkiye Milli Takımı",
    rank: { national: 1, world: 2 },
    followers: 18_200,
    supporters: 1_450,
    ...
    alive: true,
    trend: "+18%",
    socials: { instagram: "@busenazcakiroglu" },
    achievements: [
      { year: "2024", title: "Paris Olimpiyat Gümüş" },
      { year: "2023", title: "Dünya Şampiyonu" },
    ],
...
export const supporters: Supporter[] = [
  { id: "s1", name: "Mehmet Kaya",      city: "İstanbul", monthlyAmount: 250, since: "2024-09", athletes: ["mete-gazoz","zeynep-sonmez"], totalContributed: 2100 },
  { id: "s2", name: "Selin Yıldız",     city: "Ankara",   monthlyAmount: 100, since: "2025-01", athletes: ["mete-gazoz"],                  totalContributed: 600  },
  { id: "s3", name: "Ali Eren",         city: "İzmir",    monthlyAmount: 50,  since: "2024-12", athletes: ["sureyya-demir"],                totalContributed: 350  },
];
...
export const notifications: Notification[] = [
  ...
  { id: "no4", type: "match-talent", title: "Yetenek eşleşmen bulundu",   message: "Necati Er'in beslenme ihtiyacıyla eşleştin.",        time: "Dün",    read: true  },
  { id: "no5", type: "support",      title: "Destek yenilendi",           message: "Aylık ₺250 desteğin Mete Gazoz'a iletildi.",          time: "2 gün",  read: true  },
];
...
export const diaryEntries: DiaryEntry[] = [
  { id: "d1", athleteSlug: "mete-gazoz",    date: "16 May", mood: "🙏", audio: false, content: "Bugün gelen mesajların hepsini okudum. Sahaya tek başına çıkmıyorum artık." },
  { id: "d2", athleteSlug: "mete-gazoz",    date: "14 May", mood: "💭", audio: true,  content: "Antrenmandan sonra Budapeşte hakkında konuştuk. Sesli notu bırakıyorum." },
  { id: "d3", athleteSlug: "sureyya-demir", date: "15 May", mood: "💪", audio: false, content: "Salonda 5 saat. Üç bant açıları yeniden çalıştım." },
  { id: "d4", athleteSlug: "zeynep-sonmez", date: "13 May", mood: "🔥", audio: false, content: "İlk set kayıptı ama dönmesini bildim. Toprak kortta her şey mümkün." },
];
...
export const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    endDate: "27 May",
    daysLeft: 10,
    description: "Anneler Günü için aile bağı temalı tek lansman etkinliği. Buse Naz ve annesinin antrenman hikâyesi üzerinden kurgulanan duygu odaklı kampanya.",
